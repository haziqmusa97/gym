...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/Wall13.jpg);">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						...
						<a href="registration.php" style="color:blue;">Sign up</a>
						...
						<div class="text-center text-light" style="color:blue;">
							<a href="admin" style="color:blue;">Admin Login</a>
						</div>
					</div>
				</div>
			</div>
