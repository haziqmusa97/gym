...
<?php 
		 ...
		 $ret= mysqli_query($bd,"SELECT * FROM booking where id = '".$_GET['id']."'");
			...
			<tr>
			  <td colspan="2"  class="font1"><table width="100%" border="0">
                <tr>
                  <td width="32%" valign="top" class="heading">Session Code : </td>
                  
                      <td class="comb-value1"><span class="comb-value"><?php echo $row['sescode'];?></span></td>
                    </tr>
                  <tr>
                  <td width="22%" valign="top" class="heading">Time : </td>
                  
                      <td class="comb-value1"><span class="comb-value"><?php echo $row['time'];?></span></td>
                    </tr>
                    ...
                    <td width="12%" valign="top" class="heading">Fees RM : </td>
                     ...
                     <tr>
                    <td width="12%" valign="top" class="heading">Protein Status: </td>
                      <td class="comb-value1"><?php if($row['protstatus']==0)
{
...
else
{
  echo "With Protein";
                    ...
                    <tr>
                    <td width="12%" valign="top" class="heading">Start On: </td>
                      <td class="comb-value1"><?php echo $row['starton'];?></td>
                    </tr>
                    <tr>
...
<tr>
<td width="12%" valign="top" class="heading">Personal Trainer: </td>
<td class="comb-value1"><?php echo $row['trainer'];?></td>
</tr>
